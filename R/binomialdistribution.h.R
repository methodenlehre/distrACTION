...
BinomialDistributionOptions <- if (requireNamespace('jmvcore')) R6::R6Class(
...
BinomialDistributionResults <- if (requireNamespace('jmvcore')) R6::R6Class(
...
BinomialDistributionBase <- if (requireNamespace('jmvcore')) R6::R6Class(
...
BinomialDistribution <- function(
    ...
    results <- BinomialDistributionResults$new(
        options = options)
