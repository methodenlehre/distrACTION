...
FDistributionOptions <- if (requireNamespace('jmvcore')) R6::R6Class(
...
FDistributionResults <- if (requireNamespace('jmvcore')) R6::R6Class(
...
FDistributionBase <- if (requireNamespace('jmvcore')) R6::R6Class(
    "FDistributionBase",
...
FDistribution <- function(
    ...
    results <- FDistributionResults$new(
        options = options)
