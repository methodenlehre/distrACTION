...
Chi2DistributionOptions <- if (requireNamespace('jmvcore')) R6::R6Class(
...
Chi2DistributionResults <- if (requireNamespace('jmvcore')) R6::R6Class(
...
Chi2DistributionBase <- if (requireNamespace('jmvcore')) R6::R6Class(
...
Chi2Distribution <- function(
    ...
    results <- Chi2DistributionResults$new(
        options = options)
