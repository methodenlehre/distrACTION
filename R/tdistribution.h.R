...
TDistributionOptions <- if (requireNamespace('jmvcore')) R6::R6Class(
...
TDistributionResults <- if (requireNamespace('jmvcore')) R6::R6Class(
...
TDistributionBase <- if (requireNamespace('jmvcore')) R6::R6Class(
    "TDistributionBase",
...
TDistribution <- function(
    ...
    results <- TDistributionResults$new(
        options = options)
