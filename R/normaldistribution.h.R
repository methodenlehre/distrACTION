...
NormaldistributionOptions <- if (requireNamespace('jmvcore')) R6::R6Class(
...
NormaldistributionResults <- if (requireNamespace('jmvcore')) R6::R6Class(
...
NormaldistributionBase <- if (requireNamespace('jmvcore')) R6::R6Class(
...
Normaldistribution <- function(
    ...
    results <- NormaldistributionResults$new(
        options = options)
